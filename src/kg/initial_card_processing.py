...
def save_cards_df_to_json(cards_df:pd.DataFrame, save_file_name):
    cards_df_as_json = cards_df.to_json(orient = 'index') # orient = 'index' means index-oriented transformation  
...
def get_cards_df_abstraction_groups_from_meta_data(cards_df):
    """
    Converts meta data with unusual names for abstraction levels into a common format
    """
